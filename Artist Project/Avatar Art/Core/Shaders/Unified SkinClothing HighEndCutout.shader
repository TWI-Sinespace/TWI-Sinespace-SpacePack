Shader "Sine Wave/Skin/Unified Clothing and Skin (Cutout Metal + Tessellate)" {
Properties {
...
CGPROGRAM
#pragma surface surf Standard nolightmap keepalpha vertex:disp tessellate:tessEdge tessphong:_Phong alphatest:_Cutoff
